...
def get_intro():
    text = """
    <h1>Welcome to the Portfolio Selection Tool</h1>


    <h4>
    To begin, please complete the Risk Analysis Survey found in the left-hand side panel. Once you have selected your answers click on the 'submit' button.</br></br>
    ...
    (show a nice table listing the information available on each tab)
    </h4>
